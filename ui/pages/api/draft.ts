 ...
 * @returns {string}
 */
const draftPrompt = (): string => `Your goal is to assist in writing an alt text description of a figure that is as informative and accessible as possible, based on metadata provided to you.
